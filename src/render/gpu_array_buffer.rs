...
///
/// Copied over from Bevy 0.19, as changes in 0.20 do not support WebGL2.
pub struct GpuArrayBufferPlugin<C: Component + GpuArrayBufferable>(PhantomData<C>);

impl<C: Component + GpuArrayBufferable> Plugin for GpuArrayBufferPlugin<C> {
...
impl<C: Component + GpuArrayBufferable> Default for GpuArrayBufferPlugin<C> {
    fn default() -> Self {
        Self(PhantomData::<C>)
    }
}
